...
For detailed usage instructions and complete documentation about `llama.cpp`, please visit the original repository:

**Original Repository**: [https://github.com/ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp)

We do not provide specific instructions on how to use `llama.cpp` here.